...
SKY.CarouselItem.prototype = {
    init: function () {
        ...
        if (SKY.Utils.has2dTransformationSupport()) a =
            ...
            this.height = c;
            b = {
                left: this.scaledX, top: this.scaledY, width: this.width - this.extraItemSize, height: this.height -
                this.extraItemSize
            };
...
SKY.Carousel.prototype = {
    init: function () {
        ...
        var a = this.settings, b = parseInt(this.dom.items.css("padding-left")),
            c = parseInt(this.dom.items.css("border-left-width")), d = parseInt(this.dom.images.css("padding-left")),
        ...
        for (var a = this, b = this.settings, c = this.container,
            ...
            if (k <= b.motionStartDistance) var p = this.calculateAlpha(k), l = this.calculateScale(k),
                n = this.calculateExtraDistance(k); else p = b.unselectedItemAlpha, l = b.unselectedItemZoomFactor, n = 0;
        ...
        function b(a) {
            var b = a.originalEvent, c = SKY.Utils.hasTouchSupport() ? b.touches[0].clientX : a.clientX,
                g = SKY.Utils.hasTouchSupport() ? b.touches[0].clientY : a.clientY, r = (c - startX) / 2 + n;
            m = f - c;
            f = c;
            if (SKY.Utils.hasTouchSupport()) {
                ...
                t || (t = !0, Math.abs(g - h) > Math.abs(c - startX) + 5 ? d.isScrolling =
                    !0 : d.isScrolling = !1);
                if (d.isScrolling) {
                    q = !0;
                    return
        ...
        if ("A" != a.target.nodeName) {
            var d = this, g = this.settings, e = a.originalEvent,
                f = startX = SKY.Utils.hasTouchSupport() ? e.targetTouches[0].clientX : a.clientX,
                h = SKY.Utils.hasTouchSupport() ? e.targetTouches[0].clientY : a.clientY, k = this.carouselItems.length,
                p = d.centerX - (g.selectedItemDistance + g.itemWidth / 2),
                l = p - (g.itemWidth * g.unselectedItemZoomFactor + g.distance) * (k - 1), n = this.container.getLeft(),
                m = 0, t = !1, q = !1, u = !1;
            this.timer && this.timer.stop();
...
window.Modernizr = function (a, b, c) {
    ...
    var f = {}, h = b.documentElement, k =
            b.createElement("modernizr"), p = k.style, l = " -webkit- -moz- -o- -ms- ".split(" "),
        n = ["Webkit", "Moz", "O", "ms"], m = ["webkit", "moz", "o", "ms"], k = {}, t = [], q = t.slice, u,
        w = function (a, c, d, e) {
